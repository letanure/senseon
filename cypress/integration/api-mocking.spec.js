...
describe('Section one', () => {
  ...
  it('API should return status', () => {
    cy.window().then((win) => {
      cy.wrap({
        func: () => win.fetch('/api').then((response) => response.json()),
      })
        .invoke('func')
        .then((json) => {
  ...
  it('API /counter should return current value', () => {
    cy.window().then((win) => {
      cy.wrap({
        func: () =>
          win.fetch('/api/counter').then((response) => response.json()),
      })
        .invoke('func')
        .then((json) => {
  ...
  it('API /data should return some random data', () => {
    cy.window().then((win) => {
      cy.wrap({
        func: () => win.fetch('/api/data').then((response) => response.json()),
      })
        .invoke('func')
        .then((json) => {
  ...
  it('API /login should return current value', () => {
    cy.window().then((win) => {
      ...
      cy.wrap({
        func: () =>
          win.fetch('/api/login', config).then((response) => response.json()),
      })
        .invoke('func')
        .then((json) => {
